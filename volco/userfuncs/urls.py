...
from .views import get_user_data,getstats,getregisteredevents,checkstatus,getevents
...
urlpatterns = [
    ...
    path('api/user/events/', getevents,name='getevents'),  # Example endpoint for events
]